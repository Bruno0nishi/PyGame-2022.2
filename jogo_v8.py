...
game_over = False
cano_gap = 150
cano_frequencia = 1500 #millisegundos
...
Botao = Botao(screen_width // 2 - 50, screen_height // 2 - 100, Botao_img)
...
while run:
    ...
    fonte_pontuacao(str(score), font, cor_fonte, int(screen_width / 2), 20)
   ...
   # Colisão com o cano
    ...
    '''def som_pulo(self):
        self.som_pulo.play()
        self.direction = -400
        self.som_pulo = pygame.mixer.Sound('audio/sounds_jump.wav')
